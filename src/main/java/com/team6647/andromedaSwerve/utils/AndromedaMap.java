...
public class AndromedaMap {
    ...
    public static final Rotation2d mod1Angleoffset = Rotation2d.fromDegrees(0.0); // <- TODO Modify
    ...
    public static final Rotation2d mod2Angleoffset = Rotation2d.fromDegrees(0.0); // <- TODO Modify
    ...
    public static final Rotation2d mod3Angleoffset = Rotation2d.fromDegrees(0.0); // <- TODO Modify
    ...
    public static final Rotation2d mod4Angleoffset = Rotation2d.fromDegrees(0.0); // <- TODO Modify
